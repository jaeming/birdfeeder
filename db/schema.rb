...
ActiveRecord::Schema.define(version: 20150412134718) do
  ...
  add_index "subscriptions", ["hashtag_id"], name: "index_subscriptions_on_hashtag_id", using: :btree
